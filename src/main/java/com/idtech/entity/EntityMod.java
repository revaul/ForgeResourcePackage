...
public class EntityMod {
	...
	public static void createEntityWithEgg(Class entityClass, String entityName, int solidColor, int spotColor) {
		...
		EntityRegistry.registerModEntity(new ResourceLocation(BaseMod.MODID, entityName), entityClass, entityName,
				entityId, BaseMod.instance, 250, 1, true, solidColor, spotColor);
	}
